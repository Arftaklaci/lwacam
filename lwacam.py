...
psb("""\033[1;36m                   [~] ArifReis ( YAPIMCI ) [~]""")
psb("""\033[1;36m      Lwa Anka TEAM: [~] Samir ( YAPIMCI ) [~]""")
psb("""\033[1;36m                   [~] Not: Rastgele Kamera Tarar [~]""")

time.sleep(3)
print ("")
print ("")
print("""
                              \033[1;31m0) \033[1;37mGeri
...
try:
    ...
    num = int(input("\033[1;33m Ülke Numarasını Gir : "))
